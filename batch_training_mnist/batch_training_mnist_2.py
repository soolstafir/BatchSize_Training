# -*- coding: utf-8 -*-
"""
Created on Wed Sep 13 10:54:44 2017
...
def mnist_model(batch_size, use_two_fc, use_two_conv, hparam):
    ...
    for batch_size in [50, 128, 256, 1024]:
        ...
        for use_two_fc in [True]:
            for use_two_conv in [True]:
                ...
                """
                hparam = make_hparam_string(batch_size,
                                            use_two_fc,
                                            use_two_conv)
                print('\nStarting run for {0}\n'.format(hparam))
